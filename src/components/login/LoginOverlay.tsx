...
const LoginOverlay = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (isOverlayOpen && overlayRef.current && !overlayRef.current.contains(event.target as Node)) {
        closeOverlay();
      }
    };
  ...
  return (
    <div ref={overlayRef}
      className={`fixed h-[100vh] bg-white right-0 top-0 z-50 border-l-4 border-asumaroon
            md:w-[60vw] lg:w-[616px] xl:w-[860px]
            transition-transform duration-500
            ${isOverlayOpen ? 'translate-x-0' : 'translate-x-full'} hidden md:block`} >
      ...
      <div className="relative h-full w-full">
        ...
        <div className="absolute w-full p-12">
          <h1 className="text-right text-asumaroon md:text-7xl text-5xl font-neue-haas-bold">
            Level up your
          </h1>
          <h1 className="text-right text-asumaroon md:text-7xl text-5xl font-neue-haas-bold">
            Learning
          ...
          <div className="mt-40">
            <h2 className="text-asumaroon text-lg font-neue-haas-bold">EMAIL ADDRESS</h2>
            <input type="email" className="w-full bg-transparent h-8 text-black focus:bg-white" />
            <div className="bg-asumaroon w-full h-1" />
          </div>

          <div className="mt-24">
            <h2 className="text-asumaroon text-lg font-neue-haas-bold">PASSWORD</h2>
            <input type="password" className="w-full bg-transparent h-8 text-black" />
            <div className="bg-asumaroon w-full h-1" />
            <div className="flex justify-end w-full">
              <h2
                className="text-asumaroon text-md font-neue-haas-medium text-right 
          ...
          <div
            className="flex justify-center items-center mt-8 cursor-pointer w-full h-12 
                bg-asumaroon-100 text-asumaroon text-md font-neue-haas-medium 
